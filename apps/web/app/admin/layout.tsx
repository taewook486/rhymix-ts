/**
 * Admin Shell 레이아웃 — SPEC-ADMIN-001 Slice C.
 *
 * 모든 /admin/* 라우트가 이 레이아웃을 통과한다.
 * Server Component 로 session 을 검사하고 비관리자는 redirect 한다.
 *
 * @MX:ANCHOR: [AUTO] REQ-ADMIN-020/021 의 UI 진입점.
 ...
 *
 * @MX:TODO: [AUTO] requireAdmin2FAIfEnabled — Slice D Site Settings 에서 추가 예정.
...
export default async function AdminLayout({
  ...
  // TODO (Slice D — Site Settings): requireAdmin2FAIfEnabled(session)
