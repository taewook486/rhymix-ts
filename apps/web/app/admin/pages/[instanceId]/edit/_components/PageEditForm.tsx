...
/**
 * PageEditForm.tsx — SPEC-PAGE-001 Slice C + SPEC-ADMIN-002 Slice 2A
 *
 ...
 * @MX:SPEC: SPEC-PAGE-001 REQ-PAGE-031 + SPEC-ADMIN-002 REQ-ADMIN2-026, REQ-ADMIN2-027, REQ-ADMIN2-029
 */
import React, { useTransition, useState } from 'react';
import { savePageAction, deletePageAction, updatePageSettingsAction } from '../actions';
 ...
 */
export function PageEditForm({ instanceId, initialContent, instance }: PageEditFormProps): React.ReactElement {
